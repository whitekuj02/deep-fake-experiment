...
def get_argument():
    ...
    parser.add_argument("-svt", "--sound_vector_threshold", type=int, default=4037, help="fixed sound vector size")
...
## validation 처리
if args.validation:
    train, val, _, _ = train_test_split(df, df['label'], test_size=args.validation_size, random_state=args.seed)
else:
    train = df
